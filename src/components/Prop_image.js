  ...
  return (
    <main>
      <div className="property_section">
        ...
        <select className="styleSection" id="font_style" value={font_style} onChange={handleChange}>
          <option value="normal">normal</option>
        ...
        <div id="fileInfo_section" style={styleFileInfoPop}>
          <FileInfoPop_image fileInfo={attr.FILEINFO} title={propName} isReset={isReset} />
        </div>
