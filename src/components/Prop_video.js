...
const Prop_video = (e) => {
    ...
    return(
        <main>  
            ...
            <div className="borderTitle">border</div> <img id="img_down_border" src = {downArrow} alt={"down"} />
            <div id="border_section"></div>
            <div className="paddingTitle">padding</div> <img id="img_down" src = {downArrow} alt={"down"} />
            <div id="padding_section"></div>
            <div className="marginTitle">margin</div> <img id="img_down" src = {downArrow} alt={"down"} />
            <div id="margin_section"></div>
            <div className="backgroundTitle">background</div> <img id="img_down_background" src = {downArrow} alt={"down"} />
