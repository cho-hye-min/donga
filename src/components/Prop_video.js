...
const Prop_video = (component) => {
    ...
    const { prop_width, prop_height, size_input, line_height_input, url_input, field_input, photoPlace } = valEdit;
    ...
    return(
        <main>  
            ...
            <div id="fileInfo_section">{showPop.fileInfoPop ? <FileInfoPop_video fileInfo={attr.FILEINFO}/> : null}</div>
